...
namespace DVLD_System.ApplicationType_Form.FirstApp_NowLocalDL.Test_Forms
{
    public partial class frmManageWrittenTest : Form
    {
        ...
        public frmManageWrittenTest(int LDLApp)
        {
            InitializeComponent();
            _LDLApp = LDLApp;
        }
        ...
        {
            DGListTestAppointment.DataSource = clsBLManageTestAppointments.GetTestAppointmentsInfoByAppTypeID(_LDLApp , 2);
        ...
        {
            if (clsBLManageTestAppointments.IsAppointmentExist(_LDLApp , 2))
            {
            ...
            {
                if (clsBLManageTestAppointments.IsPassed(_LDLApp, 2))
                {
                ...
                {
                    frmSchedulingTest frm = new frmSchedulingTest(-1, 2, _LDLApp);
        ...
        {
            frmSchedulingTest frm = new frmSchedulingTest((int)DGListTestAppointment.CurrentRow.Cells[0].Value, 2, _LDLApp);
        ...
        {
            frmTakeTest frm = new frmTakeTest((int)DGListTestAppointment.CurrentRow.Cells[0].Value , 2);
