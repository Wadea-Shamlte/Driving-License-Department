...
namespace DVLD_System.ApplicationType_Form.FirstApp_NowLocalDL.Test_Fomes
{
    public partial class frmManageVisionTest : Form
    {
        ...
        public frmManageVisionTest(int LDLApp)
        {
            InitializeComponent();
        ...
        {
            DGListTestAppointment.DataSource = clsBLManageTestAppointments.GetTestAppointmentsInfoByAppTypeID(_LDLApp , 1);
        ...
        private void frmManageVisionTest_Load(object sender, EventArgs e)
        {
            _LoadData();
            _RefreshData();
        ...
        {
            if (clsBLManageTestAppointments.IsAppointmentExist(_LDLApp , 1))
            {
            ...
            {
                if(clsBLManageTestAppointments.IsPassed(_LDLApp , 1))
                {
                ...
                {
                    frmSchedulingTest frm = new frmSchedulingTest(-1, 1, _LDLApp);
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmSchedulingTest frm = new frmSchedulingTest((int)DGListTestAppointment.CurrentRow.Cells[0].Value, 1, _LDLApp);
        ...
        private void takeTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmTakeTest frm = new frmTakeTest((int)DGListTestAppointment.CurrentRow.Cells[0].Value , 1);
